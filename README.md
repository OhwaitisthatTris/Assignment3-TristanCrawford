...
This assignment is about implementing linked list and dynamic array.

The goal of this assignment is to write both data structures while overriding Python's dunder methods for each to make them behave like other Python sequences/collections.
...
- `README.md` this file
- `LICENSE` MIT License
- `dynamic_array.py`@ A dynamic array
